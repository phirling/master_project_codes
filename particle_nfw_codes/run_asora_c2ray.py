...
dt_c2ray = 1e4 * YEAR  # Time step to use for C2Ray time integration
...
write_output(output_dir,0,gs.u_cgs,sim.xh,0.0)
nsnap = 1
...
while (current_time < final_time):
    ...
    if current_time == next_output_time:
        write_output(output_dir,nsnap,gs.u_cgs,sim.xh,current_time/(1e6*YEAR))
        next_output_time += dt_output
        nsnap += 1
